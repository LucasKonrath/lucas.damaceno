...
import br.com.crescer.lista01.StringUtils;
import br.com.crescer.lista01.ManipulaStrings;
...
public class Chat {
    ...
    private static final StringUtils STRING_UTILS = new ManipulaStrings();
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula.txt", "@irineu"};
        }
